                            ...
                            <div className="bg-white rounded-3xl p-4 md:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
                                ...
                                <div className="prose prose-lg max-w-none prose-slate prose-headings:text-[#1a2b3c] prose-headings:font-bold prose-p:text-gray-500 prose-p:leading-relaxed">
                                    ...
                                    <ul className="space-y-4 mb-10 pl-6 list-disc">
                                        ...
                                        <li><strong>Forgetting metadata.</strong> Timestamps, authorship, and audit logs matter for regulatory compliance and clinical accountability, not just the clinical content itself. Losing them during migration creates a compliance gap even if the clinical data transferred perfectly. See our <a href="/blogs/hipaa-compliance-checklist-custom-ehr-systems-2026" target='_blank' className='text-[#60C6B1]'>HIPAA compliance checklist</a> for what auditors expect on the logging side.</li>
                                    </ul>
