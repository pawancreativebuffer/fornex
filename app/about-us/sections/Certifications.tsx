            ...
            <div className="max-w-[1400px] mx-auto px-4">
                ...
                <div className="flex flex-col items-center text-center mb-15">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] max-w-6xl mb-5">
                        Verified, Audited, and <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent">Trusted</span>
                    </h2>
                    <p className="text-gray-500 text-base font-regular leading-relaxed text-center">
                        Our compliance is independently verified - not self-reported.
                    </p>
                </div>
