    ...
    <>
          ...
          <div className="max-w-[1400px] mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
              <div className="animate-slide-left">
                <div className='text-2xl lg:text-5xl font-bold leading-[1.1] text-[#1a2b3c] mb-6 uppercase'>Approach</div>
              ...
              <div className="grid gap-2 animate-slide-right">
                <div className='text-2xl lg:text-5xl font-bold leading-[1.1] text-[#1a2b3c] mb-6 uppercase'>Challenges</div>
      ...
      {service.offerings && (
        <section className="py-10 lg:py-15 bg-[#f7fbfe]">
          <div className="max-w-[1400px] mx-auto px-4">
            <div className='text-2xl lg:text-5xl font-bold leading-[1.1] text-[#1a2b3c] mb-10 text-center uppercase'>Offerings</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-[#1a2b3c] p-5 lg:p-8 rounded-[2rem] text-white relative overflow-hidden">
                ...
                <div className="grid gap-2 z-[10] relative">
                  <div className='text-2xl lg:text-5xl font-bold leading-[1.1] text-[#fff] mb-6 uppercase'>Audience</div>
      ...
      {service.process && (
        <section className="py-10 lg:py-15 bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] text-white">
          <div className="max-w-[1400px] mx-auto px-4">
            <div className='text-2xl lg:text-5xl font-bold leading-[1.1] text-[#fff] mb-10 text-center uppercase'>Process</div>
        ...
        <section className="py-10 lg:py-15">
          <div className="max-w-[1400px] mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-2">
                <div className='text-2xl lg:text-5xl font-bold leading-[1.1] text-[#1a2b3c] mb-8 text-left uppercase'>Why Choose Us</div>

                {service.whyChooseUs.map((reason, idx) => (
                  <div key={idx} className="flex items-center gap-5 group">
                    <div className="w-8 h-8 rounded-xl bg-teal-50 text-[#60C6B1] flex items-center justify-center shrink-0 group-hover:bg-[#60C6B1] group-hover:text-white transition-all shadow-sm">
              ...
              <div className="bg-[#eff8f6] border border-[#60C6B1]/20 rounded-[30px] p-8 shadow-sm">
                {service.cta && (
                  <div className="text-center">
                    <h2 className="text-2xl lg:text-4xl font-semibold leading-tight m-auto max-w-[500px]">
                      {service.cta.text}
                    </h2>

                    <div className='flex justify-center'>
                      <Link href='/contact' className="px-5 py-3 mx-auto mt-10 rounded-full border border-[#60C6B1] text-[#fff] bg-[#60C6B1] hover:bg-[transparent] hover:text-[#60C6B1] cursor-pointer transition flex items-center gap-2 font-medium">
                        {service.cta.action}
                        <ChevronRight size={20} />
                      </Link>
                    </div>
