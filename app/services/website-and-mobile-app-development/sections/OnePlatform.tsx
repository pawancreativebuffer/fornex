...
const coreModules = [
    {
        ...
        bullets: [
            ...
            "Tailwind CSS for accessible, responsive UI design"
        ]
    },
    {
        id: "2",
        ...
        color: "#90c7e5",
        bullets: [
            "Node.js and Python for API development",
            "AWS HIPAA-eligible infrastructure (EC2, RDS, S3)",
            "Google Cloud Healthcare API",
            "PostgreSQL and MongoDB for healthcare data",
                                ...
                                >
                                    ...
                                    <div className="relative z-10 w-full">
                                        ...
                                        <div className="flex flex-col gap-6">
                                            ...
                                            <div>
                                                <span className="text-sm font-semibold tracking-[0.1em] uppercase opacity-60 block mb-2">Stack {module.id}</span>
