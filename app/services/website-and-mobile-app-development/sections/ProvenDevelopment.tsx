                ...
                <div className="relative max-w-[1400px] w-full mx-auto flex flex-col lg:flex-row min-h-[600px] xl:min-h-[100vh] px-4">
                    ...
                    <div className="w-full lg:w-2/3 py-10 lg:py-12 lg:pr-30 flex flex-col justify-center relative z-10">
                        <div className="mb-8">
                            ...
                            <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] mb-4 lg:max-w-2xl">Healthcare Mobile App Development</h2>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-20 h-full flex flex-col">
                            ...
                            <div className="mb-auto">
                                <span className="text-sm font-[500] opacity-80 mb-3 block tracking-[0.3em] uppercase">Types 0{activeService.id}</span>
