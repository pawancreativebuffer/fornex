...
const services = [
    {
        ...
        points: [],
        icon: Microscope,
        largeIcon: Microscope,
        color: "#60C6B1" // Green from HomeServices
    },
    {
        id: 2,
        title: "Solution Architecture and UI/UX Design",
        detail: "Our architects design scalable, modular systems using microservices architecture for healthcare - ensuring that your platform can grow without requiring expensive re-architecture. Our clinical UX designers create interfaces validated with actual clinicians and patients, not just internal assumptions.",
        points: [],
        icon: Layers,
        largeIcon: Layers,
    ...
    },
    {
        ...
        detail: "We build in two-week sprints with continuous integration and deployment pipelines. Stakeholders see working software every two weeks - not a finished product six months later. Integration with Epic, Cerner, Athenahealth, eClinicalWorks, and other EHR systems is handled by our dedicated interoperability team using FHIR R4 APIs and HL7 messaging.",
        points: [],
        icon: Workflow,
        largeIcon: Workflow,
    ...
    },
    {
        ...
        detail: "Before any release, our compliance team conducts HIPAA technical safeguard reviews, penetration testing, PHI data flow audits, and disaster recovery testing. We document everything - giving you the audit trail and compliance evidence you need for regulatory reviews.",
        points: [],
        icon: ShieldCheck,
    ...
    },
    {
        ...
        detail: "Go-live is just the beginning. We provide comprehensive staff training, 24/7 technical support, proactive monitoring, and continuous improvement cycles based on usage analytics and clinical feedback. Our average client relationship is over three years - because we stay engaged long after launch.",
        points: [],
        icon: Rocket,
        largeIcon: Rocket,
        color: "#c66060ff"
                ...
                <div className="relative max-w-[1400px] w-full mx-auto flex flex-col lg:flex-row min-h-[600px] xl:min-h-[100vh] px-4">
                    ...
                    <div className="w-full lg:w-2/3 py-10 lg:py-12 lg:pr-30 flex flex-col justify-center relative z-10">
                        <div className="mb-8">
                            ...
                            <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] mb-4 lg:max-w-2xl">Our Proven Development Process</h2>
                        </div>
