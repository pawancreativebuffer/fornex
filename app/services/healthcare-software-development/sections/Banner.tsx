    ...
    return (
        <div className="w-full max-w-[1400px] mx-auto px-4 py-10 lg:py-15 relative z-50">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <div className="relative w-full max-w-[550px] aspect-[4/5] mx-auto animate-slide-right order-2 lg:order-1 mt-10 lg:mt-0">
                    {/* Background glow */}
                ...
                <div className="flex flex-col gap-6 lg:gap-8 animate-slide-left order-1 lg:order-2">
                    <h1 className="text-shadow-lg/20 font-[700] text-[40px] lg:text-[56px] text-[#fff] leading-[1.1] text-center lg:text-left">
                        Custom <span className="text-[#60C6B1]">Healthcare Software Development</span> That Drives Real Clinical Results
                    </h1>
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-white/70 text-base font-regular leading-relaxed mb-4 lg:mb-6 text-center lg:text-left">
                            At ForNex Health, we build healthcare software from the ground up - designed around your workflows, your compliance requirements, and your patients. With over 10 years of exclusive experience in healthcare technology, our team has built and deployed clinical platforms for 50+ healthcare organizations across the US, UK, and beyond.
                        </p>
