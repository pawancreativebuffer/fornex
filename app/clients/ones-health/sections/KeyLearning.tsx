...
const processData = [
    {
        title: "Health data schema design cannot be an afterthought.",
        subtitle: "Data Architecture",
        icon: Database,
        color: "#60C6B1",
        before: "Blood work values, wearable exports and supplement histories all have different structures, update frequencies and privacy requirements. Designing the PostgreSQL schema to handle longitudinal biomarker records from the very first sprint rather than retrofitting it later was the decision that made the AI formula engine reliable and the platform extensible.",
    },
    {
        title: "AI prompt engineering is a product discipline, not a development task.",
        subtitle: "AI Engineering",
        icon: BrainCircuit,
        color: "#90c7e5",
        before: "Getting OpenAI to return consistent, structured supplement formulas across every possible combination of biomarker inputs required treating prompt design with the same rigor as any other module versioned prompts, structured JSON output contracts, edge case testing and iteration cycles. A loosely written prompt works in a demo. It fails in production.",
    },
    {
        title: "Multi-role platforms break when the data model speaks only one role's language.",
        subtitle: "Platform Architecture",
        icon: Network,
        color: "#ff9900",
        before: "Admin, Customer and Manufacturer all describe the same order differently: one sees a billing event, one sees a formula confirmation, one sees a production job. Building a unified data model that all three roles could read from without conflict was the single hardest architectural decision on the project, and getting it right early prevented weeks of rework.",
    },
];
            ...
            <div className="max-w-[1400px] mx-auto px-4">
                ...
                <div className="flex flex-col items-center text-center mb-15">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] max-w-5xl">
                        What Building Ones Health Taught the <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent"> ForNex Health</span> Team
                    </h2>
                </div>
