...
export default function ProjectSnapshots() {
    ...
    const flow = [
        { icon: User, title: "Client", value: "SuperSchool · superschool.org" },
        { icon: User, title: "Founder", value: "Teena Ceballos · Special Education Director" },
        { icon: Layers, title: "Industry", value: "Special Education Technology" },
        ...
        { icon: DollarSign, title: "Business Model", value: "Premium SaaS" },
        { icon: Cpu, title: "Platforms", value: "React Native · .NET · MS SQL Server" },
    ]
                ...
                <div className="max-w-[1400px] mx-auto px-4">
                    ...
                    <div className="flex flex-col items-center text-center mb-10">
                        ...
                        <p className="text-gray-500 text-base font-regular leading-relaxed">
                            A comprehensive special education management platform connecting admins, teachers, parents, and students in one unified system.
                        </p>
                    </div>
