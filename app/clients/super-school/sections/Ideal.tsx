...
import { User, Shield, Server, Layers } from "lucide-react";


const IDEAL_CARDS = [
    {
        title: "You're a founder with deep domain expertise and a defined product vision.",
        description: "The most impactful education tools are built by people who have experienced the problem firsthand. If you have the clinical knowledge, ForNex provides the full technical execution - from architecture to app store - with a team that understands education at an operational level, not just a technical one.",
        color: "#90c7e5",
        icon: User
    },
    {
        title: "You're building a multi-role platform that requires complex permission logic, not just a UI.",
        description: "SuperSchool's role-based access engine - encoding admin, teacher, and parent permissions into a precise, clinically validated decision system - is exactly the kind of rule-based architecture ForNex specializes in. Multi-role applications demand a fundamentally different level of architectural discipline than standard consumer apps.",
        color: "#ff9900",
        icon: Shield
    },
    {
        title: "You need a mobile-first product on both platforms with an enterprise-grade backend.",
        description: "SuperSchool was built in React Native for cross-platform mobile with a .NET and MS SQL Server backend - selected specifically for compliance-grade reliability, structured data integrity, and compatibility with existing institutional IT environments.",
        color: "#E3ACC8",
        icon: Server
    },
    {
        title: "You're building an MVP with a roadmap that expands significantly in subsequent phases.",
        description: "We architected SuperSchool's database schema and API contracts to be agnostic from day one. Adding the part-time teacher module in Phase 2 required no rebuild. Phase 3's reporting engine and booking system build on the same foundation - not alongside it.",
        color: "#c66060",
        icon: Layers
    }
];
