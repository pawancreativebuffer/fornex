...
const techData = [
    {
        ...
        rows: [
            ...
            ["Android App", "React Native / Kotlin", "Single codebase delivering consistent educational UX across both platforms simultaneously"],
            ["State Management", "Redux-style architecture", "Predictable state handling for multi-role access and complex student data flows"]
        ]
    },
    {
        ...
        headers: ["Layer", "Technology", "Why"],
        rows: [
            ["Backend API", ".NET (ASP.NET)", "Enterprise-grade, type-safe backend with robust data validation for education compliance logic"],
            ["Database", "MS SQL Server", "Structured relational database ideal for complex student dataset queries and IEP goal rule mapping"],
            ["Server", "Windows Server", "Consistent with existing infrastructure; enterprise hosting reliability"],
            ["Notifications", "Push Notification Engine", "Real-time parent alerts, assignment reminders, and shift handoff triggers"],
            ["Media Storage", "Cloud Storage Layer", "Secure photo and video uploads from classrooms directly to parent-visible student profiles"],
            ["Report Generator", "Structured Report Engine", "Compliance-grade document generation with student data, goal results, and timestamps"]
        ]
    },
    {
        category: "Student Data – Role Access Engine",
        icon: <GraduationCap className="w-6 h-6" />,
        color: "#ff9900",
        lightColor: "rgba(255, 153, 0, 0.1)",
        headers: ["Role", "Coverage", "Status"],
        rows: [
            ["Super Admin", "Full platform: students, teachers, parents, documents, messaging", "Encoded · Phase 1"],
            ["Teacher (Full-Time)", "Student goals, assessments, attendance, notes, media, messaging", "Encoded · Phase 1"],
            ["Teacher (Part-Time)", "Scoped access based on assigned room type and permissions", "Encoded · Phase 2"],
            ["Parent", "Child data, attendance, media, notes, direct teacher messaging", "Encoded · Phase 1"],
        ]
    },
];
        ...
        <section className="relative w-full py-10 lg:py-15 overflow-hidden bg-[#f7fbfe] mt-10 lg:mt-15">
            ...
            <div className="max-w-[1400px] mx-auto px-4 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-10">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] mb-7 max-w-7xl">
                        Enterprise Grade <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent">Education Technology</span>, Built for Mobile First Deployment
                    </h2>
                    <p className="text-gray-500 text-base leading-relaxed max-w-4xl">
                        A stack selected for data integrity, offline capability, multi-role access control, and scalable performance - the non-negotiables for special education environments.
                    </p>
                </div>
