...
const processData = [
    {
        title: "Education logic engines require domain-first thinking, not technology-first.",
        subtitle: "Product Insights",
        icon: Brain,
        color: "#60C6B1",
        before: "The role- based access engine is the entire value of this product.Investing heavily in understanding the operational logic - IEP goal structures, staff permission scopes, parent data visibility rules - before writing a single line of code was the prerequisite for everything else being trustworthy.",
    },
    {
        title: "In high-stakes care environments, clarity is more important than features.",
        subtitle: "Design Insights",
        icon: Eye,
        color: "#90c7e5",
        before: "Every screen had to answer one question: what does this staff member need to know in the next 10 seconds? Designing for cognitive load in a busy classroom - not for a demo - changed how we approached every module.",
    },
    {
        title: "Multi-role systems must be architected for expansion from day one.",
        subtitle: "Technical Insights",
        icon: Layers,
        color: "#ff9900",
        before: "We built SuperSchool's database schema and API contracts to be role-agnostic from day one. Adding part-time teacher permissions in Phase 2 required no rebuild. Phase 3's expanded reporting and booking systems build on the same foundation - not alongside it.",
    },
    {
        title: "The founder's clinical expertise is the product's competitive moat.",
        subtitle: "Process Insights",
        icon: Stethoscope,
        color: "#E3ACC8",
        before: "Working with someone who had lived the problem daily meant we never built the wrong thing. Teena's ability to validate every workflow assumption in real time compressed our discovery cycle and eliminated entire categories of rework.",
    }
];

export default function KeyLearnings() {
    const [activeIndex, setActiveIndex] = React.useState(0);
    const ActiveIcon = processData[activeIndex].icon;
            ...
            <div className="max-w-[1400px] mx-auto px-4">
                ...
                <div className="flex flex-col items-center text-center mb-15">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] max-w-5xl">
                        What Building SuperSchool Taught the <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent"> ForNex Health</span> Team
                    </h2>
                </div>
                        ...
                        <div className="relative w-full h-full flex items-center justify-center">
                            ...
                            >
                                <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_30px_rgba(0,0,0,0.05)]">
                                    ...
                                    {/* Corrected 4 Scan Markers (Synced with Items) */}
                                    <g>
                                ...
                                <div className="relative w-full h-full flex items-center justify-center">
                                    ...
                                    <div className="relative w-20 h-20 lg:w-28 lg:h-28 rounded-full bg-white shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-gray-100 flex items-center justify-center overflow-hidden">
                                        ...
                                        <div
                                            ...
                                            style={{ color: processData[activeIndex].color }}
                                        >
                                            <ActiveIcon className="w-10 h-10 lg:w-14 lg:h-14 drop-shadow-sm" strokeWidth={1.5} />
                                        </div>
                    ...
                    <div className="flex-1 max-w-2xl min-h-[460px] flex flex-col justify-center text-center lg:text-left">
                        ...
                        >
                            <div className="flex flex-col lg:flex-row items-center gap-4 mb-8">
                                ...
                                <div>
                                    <div className="text-[14px] font-black uppercase tracking-[.1em] opacity-40 mb-2">{processData[activeIndex].subtitle}</div>
                                    <div className="h-1 w-24 rounded-full bg-gray-100 overflow-hidden mx-auto lg:mx-0">
                                        <div
                                            className="h-full transition-all duration-1000 ease-out"
                                            style={{ width: `${(activeIndex + 1) * 25}%`, backgroundColor: processData[activeIndex].color }}
                                        />
                                    </div>
                                </div>
                            </div>
