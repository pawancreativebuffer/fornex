...
const consequences = [
    {
        ...
        description: "Live access to student data, notes, media, attendance",
        color: "#60C6B1"
    },
    {
        icon: Share2,
        ...
        description: "All student records in one standardized system",
        color: "#90c7e5"
    },
    {
        icon: Brain,
        ...
        description: "Shareable records generated directly from the device",
        color: "#ff9900"
    },
    {
        icon: UserMinus,
        ...
        description: "Assess and record student progress tied to defined goals",
        color: "#E3ACC8"
    },
    {
        icon: FileWarning,
        id: "05",
        title: "Scalable Multi-School Design",
        description: "Built to expand into advanced features without rebuilding the core",
        color: "#c66060"
    }
];
            ...
            <div className="max-w-[1400px] mx-auto px-4 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-5">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] max-w-[900px] mx-auto">
                        Five Clear Outcomes. <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent">One Education Platform.</span>
                    </h2>
                </div>
