...
const processData = [
    {
        title: "Student Progress Check: From 30 Minutes to Instant",
        icon: <TrendingUp className="w-10 h-10" />,
        color: "#60C6B1",
        before: "Manual review across paper binders. 30-45 minutes to compile a complete student update. Accuracy entirely dependent on the individual staff member's familiarity with specific student histories.",
        after: "Single tap in the app. Standardized assessment records deliver a complete student progress snapshot in under 10 seconds. Consistent, accurate, and independent of who is performing the check."
    },
    {
        title: "Documentation: From No Audit Trail to Instant Reports",
        icon: <FileText className="w-10 h-10" />,
        color: "#90c7e5",
        before: "No structured documentation of IEP progress decisions. Manual notes if made at all. Audit trails incomplete. Student records without any formal evidence of assessments having been recorded.",
        after: "Every assessment generates a formal digital record - student details, goal domain, result, restrictions, and timestamp. Added directly to the student file with one tap and shareable with parents instantly."
    },
    {
        title: "Parent Communication: From Phone Tag to In-App Messaging",
        icon: <MessageSquare className="w-10 h-10" />,
        color: "#ff9900",
        before: "Parents contacted via phone calls. Staff relied on hospital switchboards. No way to share media quickly. No structured record of what was communicated or when.",
        after: "Full in-app messaging between teachers and parents. Media shared directly from classroom. Message history stored per student. All communication traceable and timestamped."
    },
    {
        title: "Medication Logs: From Paper to Device-Generated Records",
        icon: <Pill className="w-10 h-10" />,
        color: "#E3ACC8",
        before: "Medication logs on paper, often incomplete. No structured format. Logs not linked to individual student profiles. Compliance risk during audits. Easily lost between staff shifts.",
        after: "Medication logs generated directly from the device, linked to student profiles with dosage and schedule data. Exportable to admin files. Compliance-ready for audit at any time."
    }
];
