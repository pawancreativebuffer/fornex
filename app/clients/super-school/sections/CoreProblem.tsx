...
const problems = [
    {
        id: "Manufacturer",
        title: "Paper Binders & Printed IEP Files",
        description: "Traditional paper-based documentation made it difficult to track student progress, update records quickly, and ensure every staff member had access to the latest information.",
        icon: NotebookText,
        accent: "#F87171"
    },
    {
        id: "Device",
        title: "Phone Calls with Parents",
        description: "Parent communication relied heavily on manual phone calls and staff availability, leading to delayed updates, inconsistent follow-ups, and missing communication records.",
        icon: Smartphone,
        accent: "#60C6B1"
    },
    {
        ...
        description: "Critical student data was stored across multiple spreadsheets and systems, creating fragmented workflows, duplicate entries, and compliance challenges.",
...
const realCons = [
    "Critical student updates lost between staff shifts",
    "No formal documentation trail for IEP goal progress",
    "Parents left uninformed about daily incidents",
    "Medication logs and behavioral notes stored in separate systems",
    "Compliance risks due to incomplete audit records"
]
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
                    ...
                    <div className="lg:col-span-12 xl:col-span-4">
                        ...
                        <p className="text-white/70 text-base leading-relaxed">
                            What staff were actually using before SuperSchool:
                        </p>
                    ...
                    <div className="lg:col-span-12 xl:col-span-8 flex flex-col justify-start">
                        ...
                        <div className="mt-12 lg:mt-0 lg:mb-12 order-1 lg:order-0">
                            <h1 className="text-shadow-lg/20 font-[700] text-4xl lg:text-6xl text-[#fff] leading-[1.1] mb-5">
                                Student Management Was <span className="text-[#60C6B1]">Slow, Manual, and Clinically Fragmented</span>
                            </h1>
                            <p className="text-white/70 text-base leading-relaxed">
                                Before SuperSchool, there was no single tool to coordinate student care across all stakeholders at the point of daily instruction. The consequences were not minor inconveniences - they were missed developmental milestones and compliance failures happening across every special education center in the country.
                            </p>
                        </div>
                        ...
                        <div className='mt-0'>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mt-8">
                                ...
                                <div className="bg-white/5 p-8 rounded-2xl border border-white/10 relative overflow-hidden shadow-xl">
                                    ...
                                    <p className="text-white/70 text-base leading-relaxed">
                                        Manual note-taking across paper binders. 20–45 minutes to compile a student update. No structured documentation of assessments. Parent communication dependent on individual staff. Medication logs generated on paper and often incomplete.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white/5 p-8 rounded-2xl border border-white/10 relative overflow-hidden shadow-xl">
                                    ...
                                    <p className="text-white/70 text-base leading-relaxed">
                                        Single app entry for all student data. Real-time parent updates via in-app messaging. Instant digital assessment records tied to IEP goals. Medication logs generated directly from the device. Consistent decisions regardless of which staff member is on duty.
                                    </p>
                                </div>
                            </div>
                        </div>
