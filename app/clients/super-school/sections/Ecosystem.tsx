...
export default function Ecosystem() {
    const data = [
        {
            title: "Super Admins",
            desc: "Full platform control across students, staff, documents",
            icon: School
        },
        {
            title: "Teachers",
            desc: "Goal setting, assessments, attendance, messaging",
            icon: User
        },
        {
            title: "Parents",
            desc: "Child data access, teacher messaging, media feeds",
            icon: Users
        },
        {
            title: "Students",
            desc: "Individual profiles, progress records, goal tracking",
            icon: UsersRound
        },
    ];
    ...
    const integrations = [
        "Pre-session IEP goal review",
        "Real-time behavioral incident logging",
        "Cross-staff student handoff documentation",
        "Pacemaker therapy progress tracking",
        "Parent-teacher instant messaging",
        "Medication schedule compliance",
        "Attendance calendar management",
        "Media sharing with families"
    ];
            ...
            <div className="max-w-[1400px] mx-auto px-4">
                <div className="bg-white rounded-[40px] p-6 lg:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-50 flex flex-col items-center gap-8 overflow-hidden relative">
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] mb-7">
                            ...
                            <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent">
                                An Entire Special Education Ecosystem.
                            </span>
                        </h2>

                        <p className="text-gray-500 text-base leading-relaxed mb-5 max-w-3xl">
                            SuperSchool is designed for education professionals across the full special education workflow - from the admin managing enrollment to the parent tracking their child's daily milestones.
                        </p>
                    </div>
                        ...
                        <div className="flex flex-wrap justify-center items-center gap-4 lg:gap-10">
                            ...
                            {data.map((item, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`relative w-full p-5 lg:p-0 md:w-40 md:h-40 lg:w-56 lg:-ml-5 lg:h-56 lg:rotate-45 bg-gradient-to-br ${colors[index]} rounded-2xl shadow-xl flex items-center justify-center group hover:scale-105 transition-transform duration-300`}
                                    >
                                        {/* Inner content (un-rotate) */}
                                        <div className="lg:-rotate-45 flex flex-col items-center text-center px-4 gap-1">
                                            ...
                                            <p className="text-white/70 font-regular text-sm leading-snug">
                                                {item.desc}
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <h2 className="text-3xl font-bold text-[#2D2D2D] leading-[1.2] md:mt-10 text-center">
                        Educational scenarios the app supports:
                    </h2>
