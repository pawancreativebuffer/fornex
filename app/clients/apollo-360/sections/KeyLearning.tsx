...
const processData = [
    ...
    },
    {
        ...
        icon: Activity,
        color: "#90c7e5",
        before: "The platform was designed starting with the daily workflows of care coaches, supervising physicians, and patients. Technology decisions followed those workflows. Reversing that sequence produces platforms that clinical teams find frustrating and abandon.",
    },
    {
        title: "Insurance reimbursement design cannot be retrofitted onto a clinical platform.",
        subtitle: "Product Insights",
        icon: CreditCard,
        color: "#ff9900",
            ...
            <div className="max-w-[1400px] mx-auto px-4">
                ...
                <div className="flex flex-col items-center text-center mb-15">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] max-w-5xl">
                        What Building Apollo 360 Health Taught the <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent"> ForNex Health</span> Team
                    </h2>
                </div>
