...
import { Scan, Stethoscope, Layers } from "lucide-react";
...
export default function Results() {
    ...
    const potential = [
        ...
        },
        {
            ...
            desc: "Reduced clinical waste, stronger audit trails, and a consistent care protocol that scales across every unit, every clinician, and every shift in the health system.",
            color: "#ff9900",
            icon: Layers,
            num: "03"
        }
