...
import { Video, CalendarCheck, Layers, Cloud, FileText } from "lucide-react";
...
const consequences = [
    ...
    },
    {
        icon: CalendarCheck,
        id: "02",
        title: "Structured Daily Care Model",
        description: "",
        color: "#90c7e5"
    },
    {
        icon: Layers,
        id: "03",
        title: "FHIR R4 Athenahealth Integration",
        description: "",
        color: "#ff9900"
    },
    {
        icon: Cloud,
        id: "04",
        title: "AWS HIPAA Infrastructure from Day One",
        description: "",
        color: "#E3ACC8"
    },
    {
        icon: FileText,
        id: "05",
        title: "Insurance Reimbursement Workflows Built In",
        description: "",
        color: "#c66060"
    }
];
            ...
            <div className="max-w-[1400px] mx-auto px-4 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-5">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#2D2D2D] max-w-[900px] mx-auto">
                        Five Clear Outcomes. <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent">One Clinical Platform.</span>
                    </h2>
                </div>
