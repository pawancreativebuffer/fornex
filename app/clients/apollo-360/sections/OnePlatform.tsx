...
const coreModules = [
    ...
    {
        id: "5",
        title: "Insurance Billing Infrastructure",
        ...
        <section className="relative w-full py-10 lg:py-15 bg-[#f7fbfe]">
            <div className="max-w-[1400px] mx-auto px-4">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
                    ...
                    <div className="w-full lg:w-[45%] lg:sticky lg:top-15">
                        <div className="mb-10">
                            ...
                            <h2 className="text-4xl lg:text-6xl font-bold leading-[1.1] text-[#1a2b3c] mb-4 lg:mb-6">
                                A 6-Module Clinical Platform <span className="bg-gradient-to-r from-[#60c6b1] to-[#90c7e5] bg-clip-text text-transparent">Designed for Real Clinicians</span>
                            </h2>
                    ...
                    <div className="w-full lg:w-[55%] flex flex-col gap-10 overflow-hidden">
