...
const techData = [
    {
        ...
        rows: [
            ...
            ["Web Portal", "React", "Component-based architecture optimized for complex multi-role clinical UI workflows"],
            ["State Management", "Redux-style architecture", "Predictable state handling for multi-step care team workflows and conditionality logic"]
        ]
    },
    {
    ...
    {
        category: "EHR Integration Layer",
