            ...
            <div className="max-w-[1400px] mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex gap-4 p-4 rounded-[20px] bg-white/5 border border-white/10 hover:border-[#60C6B1]/30 transition-colors group">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-sm leading-relaxed">Physicians, coaches, patients</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 p-4 rounded-[20px] bg-white/5 border border-white/10 hover:border-[#60C6B1]/30 transition-colors group">
                                ...
                                <div>
                                    <h4 className="text-white font-semibold text-[20px] mb-1">Patient-Centered Design</h4>
                                    <p className="text-white/70 text-sm leading-relaxed">Built for chronic conditions</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-5 relative">
                        <div className="relative aspect-[3/5] rounded-[2rem] overflow-hidden group">
                            <Image
                                src="/images/dr-ghalchi.jpg"
                                alt="client"
                                fill
                    ...
                    <div className="relative p-10 lg:p-10 rounded-[1rem] lg:rounded-[3rem] bg-gradient-to-br from-white/10 to-transparent border border-white/10 overflow-hidden group">
                        ...
                        <div className="max-w-[900px] mx-auto text-center space-y-8">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <h4 className="text-xl font-semibold text-white uppercase mb-1">Dr. Michael Ghalchi, MD, FACC</h4>
                                <p className="text-[#60C6B1] font-medium">Founder, Apollo 360 Health</p>
                            </div>
                        </div>
                    </div>
                </div>
