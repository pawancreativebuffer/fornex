    ...
    const timeline = [
        {
            title: "Discovery",
            time: "Step 1",
            desc: "Stakeholder interviews, care protocol mapping, user persona research",
            color: "#9297a5", // Gray
            icon: Binoculars,
        },
        {
            title: "Architecture",
            time: "Step 2",
            desc: "HIPAA infrastructure design, FHIR R4 contracts, data modeling",
            color: "#3491f7", // Blue
            icon: Layers,
        },
        {
            title: "Design",
            time: "Step 3",
            desc: "Wireframes, high-fidelity prototypes, multi-role design system",
            color: "#45c79b", // Green
            icon: Diamond,
        },
        {
            title: "Development",
            time: "Step 4",
            desc: "Full-stack build with embedded QA and HIPAA compliance verification",
            color: "#f3a126", // Orange
            icon: DoorOpen,
        },
        {
            title: "Beta Launch",
            time: "Step 5",
            desc: "Staged rollout with structured clinical feedback loops",
            color: "#e74c7c", // Pink
            icon: MessageSquare,
        },
        {
            title: "Optimization",
            time: "Step 6",
            desc: "Performance monitoring, iteration cycles, Phase 2 planning",
            color: "#8234c5", // Purple
            icon: Settings,
        },
    ]
