...
const STORY_PAGES = [
    {
        ...
        description: "Outdated manuals clinicians relied on to check device compatibility.",
        image: "/images/mripro1.webp",
        color: THEME_COLORS[0].gradient,
        accent: THEME_COLORS[0].hex,
        info: 'before'
    },
    {
        title: "Instant Dashboard View",
        description: "Recent checks with color-coded results visible the moment you open the app.",
        image: "/images/mripro2.webp",
        color: THEME_COLORS[0].gradient,
        accent: THEME_COLORS[0].hex,
        info: 'after'
    },
    {
        title: "Phone Calls to Device Reps",
        description: "Slow, undocumented calls to manufacturer representatives unavailable after hours.",
        image: "/images/mripro3.webp",
        color: THEME_COLORS[1].gradient,
        accent: THEME_COLORS[1].hex,
        info: 'before'
    },
    {
        title: "One-Tap OCR Scanning",
        description: "Take a photo or choose from gallery = device details extracted automatically in seconds.",
        image: "/images/mripro4.webp",
        color: THEME_COLORS[1].gradient,
        accent: THEME_COLORS[1].hex,
        info: 'after'
    },
    {
        title: "Manual Device Card Lookup",
        description: "Reading the patient's wallet card then searching four manufacturer websites one by one.",
        image: "/images/mripro5.webp",
        color: THEME_COLORS[2].gradient,
        accent: THEME_COLORS[2].hex,
        info: 'before'
    },
    {
        title: "Structured Manual Entry",
        description: "Select device type, enter model number, add patient name and date of birth = clean, fast, and error-proof.",
        image: "/images/mripro6.webp",
        color: THEME_COLORS[2].gradient,
        accent: THEME_COLORS[2].hex,
        info: 'after'
    },
    {
        title: "Manual Device Card Lookup",
        description: "Reading the patient's wallet card then searching four manufacturer websites one by one.",
        image: "/images/mripro7.webp",
        color: THEME_COLORS[3].gradient,
        accent: THEME_COLORS[3].hex,
        info: 'before'
    },
    {
        title: "Color-Coded Results Instantly",
        description: "Green, Yellow, Orange or Red = every result is clear, dated, and saved to history automatically.",
        image: "/images/mripro8.webp",
        color: THEME_COLORS[3].gradient,
        accent: THEME_COLORS[3].hex,
        info: 'after'
    },
    {
        title: "Difficult MRI Center Search",
        description: "Patients often struggled to find MRI centers for CIED scans, making the process slow and stressful.",
        image: "/images/mripro9.png",
        color: THEME_COLORS[4].gradient,
        accent: THEME_COLORS[4].hex,
        info: 'before'
    },
    {
        title: "1,397 MRI Centers Nearby",
        description: "Search and filter MRI centers & hospitals across the US with address, phone, & ratings in one place.",
        image: "/images/mripro10.jpg",
        color: THEME_COLORS[4].gradient,
        accent: THEME_COLORS[4].hex,
        info: 'after'
    },
