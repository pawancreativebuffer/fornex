                    ...
                    <div className="w-full lg:w-1/2 flex flex-col">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12 mt-4">
                            ...
                            <div className="animate-slide-up" style={{ animationDelay: '200ms' }}>
                                ...
                                <div className="space-y-1">
                                    <p className="text-gray-500 text-base">
                                        C-127, 4th Floor, Phase-8, Industrial Area, Sector 73, Sahibzada Ajit Singh Nagar, Punjab 160071
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="animate-slide-up" style={{ animationDelay: '400ms' }}>
                                ...
                                <div className="flex items-center gap-2 order-3 md:order-1">
                                    <Link href="https://www.facebook.com/fornexhealth" target="_blank" className="w-9 h-9 flex items-center justify-center bg-gray-200/60 hover:bg-[#64d2b1] hover:text-[#fff] rounded-full transition-all text-gray-400">
                                        <Facebook size={18} />
                                    </Link>
                                    <Link href="https://www.x.com/fornex-health/" target="_blank" className="w-9 h-9 flex items-center justify-center bg-gray-200/60 hover:bg-[#64d2b1] hover:text-[#fff] rounded-full transition-all text-gray-400">
                                        <span className="font-bold text-[18px]">X</span>
                                    </Link>
                                    <Link href="https://www.instagram.com/fornex-health/" target="_blank" className="w-9 h-9 flex items-center justify-center bg-gray-200/60 hover:bg-[#64d2b1] hover:text-[#fff] rounded-full transition-all text-gray-400">
                                        <Instagram size={18} />
                                    </Link>
                                    <Link href="https://www.linkedin.com/company/fornex-health/" target="_blank" className="w-9 h-9 flex items-center justify-center bg-gray-200/60 hover:bg-[#64d2b1] hover:text-[#fff] rounded-full transition-all text-gray-400">
                                        <Linkedin size={18} />
                                    </Link>
                                </div>
                            </div>
