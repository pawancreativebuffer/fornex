...
const testimonials = [
    {
        id: 4,
        text: "The ForNex Health team delivered a secure and scalable platform that perfectly fits our educational workflows. Their attention to compliance and system integration made the entire process smooth and successful.",
        name: "Teena Ceballos",
        role: "Founder, SuperSchool.org",
        image: "/images/teena.png",
        rating: 5
    },
    {
        id: 1,
